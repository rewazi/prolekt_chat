...
export default function Header() {
  ...
  return (
    <div className="flex justify-between h-[100px] px-[85px] py-[15px] bg-[#1E1E1E]">
      ...
      <div className="flex items-center px-[20px] hover:bg-[#464646] rounded-[25px] w-[300px]" onClick={() => setMenuOpen(!menuOpen)}>
      ...
      {menuOpen && (
        <div className="absolute right-0 mt-[55px] bg-[#2e2e2e] rounded-[25px] z-50">
          <button
            className="block w-full text-left px-[10px] py-[10px] text-[18px] text-white hover:bg-[#3a3a3a]"
            onClick={changeNickname}> Change nickname</button>
          <button className="block w-full text-left px-[10px] py-[10px] text-[18px] text-white hover:bg-[#3a3a3a]">
