  ...
  return (
    <div className="flex h-screen w-screen">
      ...
      <main className="flex flex-1 flex-col bg-[#121212]">
        ...
        <Header username={username} setUsername={setUsername} setIsModalOpen={setIsModalOpen} setRegisterModalOpen={setRegisterModalOpen} setLoginModalOpen={setLoginModalOpen} search={search} setSearch={setSearch}/>
