...
import LoginModal from '../../windows/login_modal_window';
...
export default function ChatRoom() {
  ...
  useEffect(() => {
    ...
    const socket = new WebSocket(`ws://localhost:8080?PHPSESSID=${sessionId}`);
    socket.onopen = () => {
  ...
  return (
    <>
      ...
      <LoginModal isOpen={loginModalOpen} setIsOpen={setLoginModalOpen} setUsername={setUsername}/>
      ...
      <div className="flex h-screen w-screen overflow-hidden">
        ...
        <main className="flex flex-1 flex-col bg-[#121212] min-w-0">
          <Header username={username} setUsername={setUsername} setIsModalOpen={setIsModalOpen} setRegisterModalOpen={setRegisterModalOpen} setLoginModalOpen={setLoginModalOpen} chats={[]} search="" setSearch={() => {}} />
